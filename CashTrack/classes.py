...
from PySide2.QtCore import Slot, Qt, QPropertyAnimation, QEasingCurve, QJsonDocument, QFile, QIODevice, Property, QDate
...
EXPENSE_TYPES = ["Personal", "Debt", "Rent", "Mortgage", "Car Insurance", "House Insurance", "Life Insurance", "Health Insurance", "Child Expense", "Gift", "Travel", "Education", "Restaurant", "Bar", "Grocery", "Car Repair", "Gasoline", "Shopping", "Luxuries", "Entertainment", "Hobbies", "Alcohol", "Tobacco", "Other"]
...
class PieChartPage(QWidget):
    ...
    def initUI(self):
        ...
        self.place_hold.setFixedSize(1000, 202)
        ...
        self.time_box.setFixedSize(500, 195)
        self.time_box.hide()
        self.time_layout = QVBoxLayout()
        self.time_box.setLayout(self.time_layout)

        self.small_place_hold = QFrame()
        self.small_place_hold.setFixedSize(500, 195)
        ...
        self.timeline_options.setFixedSize(250, 200)
        ...
        self.data_options.setFixedSize(250, 200)
        ...
        self.type_options.setFixedSize(510, 560)
        ...
        self.chart_holder.setFixedSize(1000, 580)
    ...
    def showProgress(self, func, *pargs, **kargs):
        ...
        self.bar.setFixedSize(250, 20)
        self.bar.setMinimum(0)
        self.bar.setMaximum(0)
        self.bar.setOrientation(Qt.Horizontal)
        self.options_layout.addWidget(self.bar, 2, 1, 1, 1)
        self.bar.show()
        self.bar.setValue(1)
...
class BarChartPage(QWidget):
    ...
    def initUI(self):
        ...
        self.options_widget.setFixedSize(300, 400)
        ...
        self.chartHolder.setFixedSize(900, 900)
...
class InfoFrame(QFrame):
    ...
    def initUI(self):
        ...
        self.totalLabel.setFixedSize(380, 30)
        ...
        self.addEditRemoveHolder.setFixedSize(380, 200)
...
class FrontPage(QWidget):
    ...
    def initUI(self):
        ...
        self.img_label.setPixmap(QPixmap(os.getcwd() + "/assets/front_page_img.jpg").scaled(1000,1000, Qt.KeepAspectRatio))
...
class SignInPage(QWidget):
    ...
    def choiceExist(self):
        ...
        self.sign_in_label = TextEditLabel("Enter name:", 27)
...
class CalendarPage(QWidget):
    ...
    def initUI(self):
        ...
        self.calendar.setFixedSize(800, 700)
        ...
        self.totals_frame.setFixedSize(800, 150)
